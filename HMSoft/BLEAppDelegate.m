...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.bleViewController = [[BLEViewController alloc] initWithNibName:@"BLEViewController" bundle:nil];
    UIView *bleView = self.bleViewController.view;
    ...
    self.navController = [[UINavigationController alloc] initWithRootViewController:bleViewController];
